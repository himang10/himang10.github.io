...
If you want to skip the background about what TensorFlow is and why you’d want to use serverless for machine learning, the [actual example](https://serverless.com/blog/using-tensorflow-serverless-framework-deep-learning-image-recognition/#the-basic-4-line-example) starts here.
...
([AWS Referenece](https://aws.amazon.com/blogs/machine-learning/deploy-deep-learning-models-on-amazon-ecs/))
...
<img src="/files/serverless-deep-learning-panda.png" width="300">

Note: The model and example are also available [here](https://www.tensorflow.org/tutorials/images/hub_with_keras).
